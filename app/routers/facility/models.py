...
class Site(NamedObject):
    ...
    short_name: str | None = Field(
        default=None, description="Common or short name of the Site.", example="NERSC"
    )
    ...
    country_name: str | None = Field(
        default=None, description="Country name of the Location.", example="United States"
    )
    locality_name: str | None = Field(
        default=None, description="City or locality name of the Location.", example="Berkeley"
    )
    state_or_province_name: str | None = Field(
        default=None, description="State or province name of the Location.", example="California"
    )
    street_address: str | None = Field(
        default=None, description="Street address of the Location.", example="1 Cyclotron Rd"
    )
    ...
    altitude: float | None = Field(
        default=None, description="Altitude of the Location.", example=52.0
    )
    latitude: float | None = Field(
        default=None, description="Latitude of the Location.", example=37.8762
    )
    longitude: float | None = Field(
        default=None, description="Longitude of the Location.", example=-122.2506
    )
    ...
    def resource_uris(self) -> list[str]:
        ...
        return [
            f"{get_url_prefix()}/status/resources/{resource_id}"
    ...
    def find(
        ...
        items = super().find(
            items, name=name, description=description, modified_since=modified_since
        )
        if short_name:
...
class Facility(NamedObject):
    ...
    short_name: str | None = Field(
        default=None, description="Common or short name of the Facility.", example="ESnet"
    )
    ...
    support_uri: HttpUrl | str | None = Field(
        default=None,
